...
class ThalliumContainerVC: UIPageViewController,UIPageViewControllerDelegate,UIPageViewControllerDataSource {
    lazy var orderedViewControllers: [UIViewController] = {
        return getControllers(tag: "th") // use first letter of isotope as the tag!
    }()
