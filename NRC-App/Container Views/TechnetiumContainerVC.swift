...
class TechnetiumContainerVC: UIPageViewController,UIPageViewControllerDelegate,UIPageViewControllerDataSource {
    lazy var orderedViewControllers: [UIViewController] = {
        return getControllers(tag: "t") // use first letter of isotope as the tag!
    }()
